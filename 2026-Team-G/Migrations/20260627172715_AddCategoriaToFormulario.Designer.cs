...
namespace _2026_Team_G.Migrations
{
    ...
    [Migration("20260627172715_AddCategoriaToFormulario")]
    partial class AddCategoriaToFormulario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_2026_Team_G.Models.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("_2026_Team_G.Models.Resposta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("FormFieldModelId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("_2026_Team_G.Models.Submissao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("_2026_Team_G.Models.Formulario", b =>
                {
                    b.HasOne("_2026_Team_G.Models.Categoria", "Categoria")
                        .WithMany()
            ...
            modelBuilder.Entity("_2026_Team_G.Models.Resposta", b =>
                {
                    b.HasOne("_2026_Team_G.Models.FormFieldModel", "FormFieldModel")
                        .WithMany()
                        .HasForeignKey("FormFieldModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("_2026_Team_G.Models.Submissao", "Submissao")
                        .WithMany("Respostas")
                        .HasForeignKey("SubmissaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FormFieldModel");
            ...
            modelBuilder.Entity("_2026_Team_G.Models.Submissao", b =>
                {
                    b.HasOne("_2026_Team_G.Models.Formulario", "Formulario")
                        .WithMany()
                        .HasForeignKey("FormularioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
